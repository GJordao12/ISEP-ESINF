...
public class BST<E extends Comparable<E>> implements BSTInterface<E> {
     ...
     * @return the distance
     */
    public int findDistance(BST.Node<E> root, E a, E b) {

        BST.Node<E> lca = LCA(root, a, b);
     ...
     */
    public BST.Node<E> LCA(BST.Node<E> root, E n1, E n2) {
        ...
        BST.Node<E> left = LCA(root.getLeft(), n1, n2);
        BST.Node<E> right = LCA(root.getRight(), n1, n2);
     ...
     * @return the level
     */
    public int findLevel(BST.Node<E> root, E a, int level) {
